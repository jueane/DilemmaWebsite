...
public class HttpsClient {
	...
	public static String sendMsgOfCert(String urlString, String requestData, String CLIENT_CERT_PWD,
			String CLIENT_CERT_PATH, String TRUST_CERT_PWD, String TRUST_CERT_PATH) {
